...
class ProviderConfig(_StrictModel):
    ...
    stream: Optional[bool] = Field(
        default=None,
        description="Enable or disable streaming at the provider level",
    )
...
class AgentLLMConfig(_StrictModel):
    ...
    stream: Optional[bool] = Field(
        default=None,
        description="Enable or disable streaming at the agent level",
    )
...
class LLMConfig(_StrictModel):
    ...
    @classmethod
    def from_provider_and_agent_configs(cls, provider_config: ProviderConfig, agent_config: AgentLLMConfig):
        return cls(
            provider=agent_config.provider or provider_config.provider,
            ...
            stream=agent_config.stream if agent_config.stream is not None else provider_config.stream or False,
        )
...
class Config(_StrictModel):
    ...
    agent: dict[str, AgentLLMConfig] = Field(
        default={
            ...
            CODE_MONKEY_AGENT_NAME: AgentLLMConfig(model="gpt-4o-2024-05-13", temperature=0.0),
            ...
            SPEC_WRITER_AGENT_NAME: AgentLLMConfig(model="gpt-4o-2024-05-13", temperature=0.0),
