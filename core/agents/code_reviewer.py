...
class CodeReviewer(BaseAgent):
    ...
    def _get_task_convo(self) -> AgentConvo:
        ...
        # **This FIXME requires updating prompt templates, please provide the relevant prompt files.**
        ...
        # TODO: We currently show the last iteration to the code reviewer; consider showing the task
        # breakdown and all iterations instead when refactoring prompts
    ...
    def apply_diff(self, file_name: str, old_content: str, hunks: list[str], fallback: str):
        ...
        with all the changes applied (as if the reviewer approved everything).
